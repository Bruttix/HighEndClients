    ...
    if (cbdToggle) {
      ...
      return (
        <p className="card_description_paragraph">
              Haircut & beard trim with optional straight razor. How towel facial service including a face scrub and a facial mask.
        </p>
      );
    }
  };
      ...
      <div className="big_screen_entire_bottom_wrapper">
        <div className="big_screen_price_wrapper">
          <FontAwesomeIcon
            ...
            icon={faTag}
          />
          <p className="big_screen_price">$125</p>
        </div>
        <div className="big_screen_duration_wrapper">
          <FontAwesomeIcon
            ...
            icon={faClock}
          />
          <p className="big_screen_duration">75 minutes</p>
        </div>
      </div>
    );
  };
                  ...
                  >
                    <div className="card_description_inner_wrapper">
                      <div className="cbd_card_new_wrapper">
                        <h2 style={{ fontWeight: 400 }}>High End Service</h2>
                        {/*<h2
                      ...
                      <p
                        ...
                        style={{ opacity: 0.6 }}
                      >
                        Full hair & beard trim with mini facial and aftercare
                      </p>
