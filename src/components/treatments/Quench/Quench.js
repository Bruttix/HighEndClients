    ...
    if (quenchToggle) {
      ...
      return (
        <p className="card_description_paragraph">
          Executive Experience Hair & Beard treatment with top shelf product aftercare.
        </p>
      );
    }
  };
      ...
      <div className="big_screen_entire_bottom_wrapper">
        <div className="big_screen_price_wrapper">
          <FontAwesomeIcon
            ...
            icon={faTag}
          />
          <p className="big_screen_price">$75</p>
        </div>
                ...
                <section className="card" style={styleprops}>
                  ...
                  >
                    <div className="card_description_inner_wrapper">
                      <h2 style={{ fontWeight: 400 }}>Executive Experience</h2>
                      <p
                        className="card_description_subheader"
                        style={{ opacity: 0.6 }}
                      >
                        Executive Hair & Beard haircut with aftercare
                      </p>
