...
import ACTION_GLOWTWO_TOGGLE from "../../../actions/Treatments/GlowTwo/ACTION_GLOWTWO_TOGGLE";
...
import ACTION_GLOWTWO_IN_CART from "../../../actions/InCart/Treatments/GlowTwo/ACTION_GLOWTWO_IN_CART";
import ACTION_GLOWTWO_NOT_IN_CART from "../../../actions/InCart/Treatments/GlowTwo/ACTION_GLOWTWO_NOT_IN_CART";
...
import GlowTwoNotification from "./GlowTwoNotification";
import GlowTwoRemovedNotification from "./GlowTwoRemovedNotification";
...
const GlowTwo = (props) => {
  ...
  const handleToggle = () => {
    if (!glowTwoToggle) {
      dispatch(ACTION_GLOWTWO_TOGGLE());
      if (calmToggle) {
    ...
    if (glowTwoToggle) {
      ...
      return (
        <p className="card_description_paragraph">
          A gentle happy haircut or styling from our professionals.
        </p>
      );
    }
  };
        ...
        {(styles) => (
            ...
            style={{
              marginTop:
                props.currentScreenSize === ""
                  ...
                  ? "-0.5rem"
                  : "0rem",
              display: glowTwoInCart ? "block" : "none",
            }}
          ...
          >
            <path
              ...
              strokeDasharray="100"
              strokeDashoffset={
                cartClicked ? (glowTwoInCart ? `${styles.x}` : 0) : 0
              }
              strokeLinecap="round"
  ...
  const addToCart = () => {
    if (
      ...
      if (glowTwoInCart) {
        toast.dismiss();
        dispatch(ACTION_GLOWTWO_NOT_IN_CART());
        ...
        toast.dismiss();
        dispatch(ACTION_GLOWTWO_IN_CART());
        ...
        {(styles) => (
          ...
          >
            ...
            <FontAwesomeIcon
              ...
              style={{ display: glowTwoInCart ? "none" : "block" }}
              color={
                bacialInCart |
                  cbdInCart |
                  chemicalPeelInCart |
  ...
  const smallScreenBottomWrapperRender = () => {
    return (
      <div
        ...
        style={{
          color: glowTwoToggle ? "rgb(0, 104, 152)" : "rgb(0, 129, 177)",
          transition: "ease all 0.5s",
        }}
      >
        <p className="card_toggler" onClick={handleToggle}>
          {glowTwoToggle ? "SEE DESCRIPTION" : "LEARN MORE"}
        </p>
              ...
              {(styleprops) => (
                <section className="card" style={styleprops}>
                  <div
                    ...
                    style={{
                      backgroundColor: glowTwoToggle
                        ? "rgba(0, 129, 177, 0.2)"
                        : "rgba(211, 211, 211, 0.4)",
                      boxShadow: glowTwoToggle
                  ...
                  >
                    <div className="card_description_inner_wrapper">
                      <h2 style={{ fontWeight: 400 }}>Children's Haircut</h2>
                      <p
                        className="card_description_subheader"
                        style={{ opacity: 0.6 }}
                      >
                        Personalized styling or cutting for young girls age's 12 and under hair.
                      </p>
