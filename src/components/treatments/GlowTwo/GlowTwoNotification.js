...
const GlowTwoNotification = (props) => {
  return (
    <div className="notification_container">
      ...
      <div className="notification_text_container">
        <h3>Children's Haircut Added!</h3>
        <p>The Young Girl's Haircut selection has been added to your cart</p>
      </div>
    </div>
  );
};

export default GlowTwoNotification;
