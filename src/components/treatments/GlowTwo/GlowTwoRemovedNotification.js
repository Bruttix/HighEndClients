...
const GlowTwoRemovedNotification = (props) => {
  return (
    <div className="notification_removed_container">
      ...
      <div className="notification_text_container">
        <h3>Children's Haircut Removed!</h3>
        <p>The Children's Haircut selection has been removed.</p>
      </div>
    </div>
  );
};

export default GlowTwoRemovedNotification;
