    ...
    >
      <section className="main_content">
              ...
              >
                {(styleopacity) => (
                  ...
                  >
                    ...
                    >
                      <span id="container">
                       <img id="imgLOGO" src="https://res.cloudinary.com/dqbkfteqj/image/upload/v1656051386/highendLOGOnew-removebg_azy509.png" alt="your_keyword"/>
                      </span>
                    </p>
                    ...
                    >
                      <div className="neon-button2"
                        style={{
                          opacity: splashScreenComplete ? "1" : `${styleopacity.opacity}`,
                        }}
                      >
                        <p onClick={() => handleClickToScrollToTreatments("cta")}>
                           Get Started 
                        </p>
                      </div>
                    </div>
        ...
        <div className="splash_screen">
          ...
          <h1 style={{ position: "absolute", zIndex: -1 }}>High End</h1>
        </div>
      </section>
    </div>
  );
