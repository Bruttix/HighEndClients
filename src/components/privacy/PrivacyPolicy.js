  ...
  return (
    <div className="policy_main_container">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to High End Barbershop, LLC, 20210 Stone Oak Parkway, San Antonio, Texas, 78258.
          </p>
        </li>
        <li>
          <p>
            <strong>Cookies</strong> are small event listeners that may or may not be placed on your
            computer to help improve overall experience not excluding mobile devices.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to High End Barbershop, accessible
            from{" "}
            <a
              href="https://www.vagaro.com/highendbarbershop1"
              target="_blank"
              rel="noopener noreferrer"
            >
              https://www.vagaro.com/highendbarbershop1
            </a>
          </p>
        </li>
        <li>
      ...
      <p>
        ...
        <a href="HighEndMailer@gmail.com">HighEndMailer@yahoo.com</a> to request deletion
        of your data.
      </p>
      ...
      <ul>
        <li>
          <p>By email: HighEndMailer@gmail.com</p>
        </li>
        <li>
          <p>By phone number: +1 (210) 465 - 7474</p>
        </li>
      </ul>
