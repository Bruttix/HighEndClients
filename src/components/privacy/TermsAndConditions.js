...
const TermsAndConditions = () => {
  ...
  return (
    <div className="policy_main_container">
      ...
      <p>
        <i>Last updated: May 1st, {new Date().getFullYear()}</i>
      </p>

      <p>Welcome to High End Barbershop!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of High End's Website, located at https://www.vagaro.com/us04/highendbarbershop1.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use High End Barbershop if you do not
      ...
      <p>
        We employ the use of cookies. By accessing High End Barbershop, you
        agreed to use cookies in agreement with the High End Barbershop's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, High End Barbershop and/or its licensors own the
        intellectual property rights for all material on High End Barbershop.
        All intellectual property rights are reserved. You may access this from
        High End Barbershop for your own personal use subjected to restrictions
        set in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from High End Barbershop</li>
        <li>Sell, rent or sub-license material from High End Barbershop</li>
        <li>Reproduce, duplicate or copy material from High End Barbershop</li>
        <li>Redistribute content from High End Barbershop</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. High
        End Barbershop does not filter, edit, publish or review comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of High End Barbershop or its agents and affiliates. Comments reflect the views
        and opinions of the person who post their views and opinions. To the
        extent permitted by applicable laws, High End Barbershop shall not be liable for
      ...
      <p>
        High End Barbershop reserves the right to monitor all comments and to remove any
      ...
      <p>
        You hereby grant High End Barbershop a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of High End Barbershop; and (d) the link is
      ...
      <p>
        ...
        e-mail to High End Barbershop. Please include your name, your organization name,
      ...
      <p>
        No use of High End Barbershop's logo or other artwork will be allowed for linking
