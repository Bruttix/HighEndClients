    ...
    if (hydroJellyToggle) {
      ...
      return (
        <p className="card_description_paragraph">
          This customized steam facial calms skin, clarifying pores and
          refining skin's texture while giving your face hydration like never before.
        </p>
      );
    }
  };
                ...
                <section className="card" style={styleprops}>
                  ...
                  >
                    <div className="card_description_inner_wrapper">
                      <h2 style={{ fontWeight: 400 }}>Steam Facial</h2>
