    ...
    if (extraExtractionsToggle) {
      ...
      return (
        <p className="card_description_paragraph">
              Mens hair coloring service provided where you lose some of the gray hair
              while keeping it looking natural and stylish.
        </p>
      );
    }
  };
                ...
                <section className="card" style={styleprops}>
                  ...
                  >
                    <div className="card_description_inner_wrapper">
                      <h2 style={{ fontWeight: 400 }}>Lose the Gray</h2>
