...
import ACTION_SELECTED_NANO_NEEDLING_DURATION from "./../../../actions/AddOns/Nanoneedling/nanoneedlingDuration/ACTION_SELECTED_NANO_NEEDLING_DURATION";
          ...
          <div className="card_description_paragraph_toggle">
            <div className="card_description_icon_wrapper_container">
              ...
              <FormGroup className="salt_cave_time_formgroup">
                <div className="salt_cave_time_formgroup_dropdown_input_field">
                  ...
                  <Input
                    ...
                    value={selectednanoneedlingDuration.toString() + " minutes"}
                    onChange={(e) => {
                      dispatch(
                        ACTION_SELECTED_NANO_NEEDLING_DURATION(
              ...
              <div className="card_description_paragraph_value salt_cave_ios_price">
                <p>${selectednanoneedlingDuration}</p>
              </div>
            </div>
          </div>
        </>
    ...
    if (chemicalPeelInCart || saltCaveInCart) {
      ...
      if (microneedleInCart) {
        ...
        if (nanoneedlingInCart) {
          ...
          toast.dismiss();
            dispatch(ACTION_NANONEEDLING_IN_CART(selectednanoneedlingDuration));
      ...
      <div className="big_screen_entire_bottom_wrapper">
        <div className="big_screen_price_wrapper">
          <FontAwesomeIcon
            ...
            icon={faTag}
          />
          <p className="big_screen_price">${selectednanoneedlingDuration}</p>
        </div>
            ...
            <div className="salt_cave_time_formgroup_dropdown_input_field">
              ...
              <Input
                ...
                onChange={(e) => {
                  ...
                  if (nanoneedlingInCart) {
                    props.resetAllCartStatesExceptTreatment();
                    dispatch(
                      ACTION_SELECTED_NANO_NEEDLING_DURATION(
                        Number(e.target.value.slice(0, 2))
                      )
